let channels = {
    ...
    "Skills":[
        '<h2>Web Development</h2><p>I am currently enrolled in the Coding program at West-MEC. In this program we have covered HTML, CSS, JS, and Jquery to an indermediate level and created many websites with these skills. The program also helps us earn the Information Technology Specialist OD 301 HTML/CSS and Information Technology Specialist OD 302 Java Script certifications.</p>',
        '<h2>Python</h2><p>The Coding program at West-MEC also covers python to an intermediate level. We focus on puzzles with the language covering topics like math, algorithms, regex, and recursion. The certifications we will earn for Python are the PCEP and PCAP (PCAP is after year two of the program).</p>',
    ...
    "Projects":[
        ...
        '<h2><a class="link" href="https://jevenshirrell.github.io/pc_store_website/">PC Store Website</a></h2><img src="./imgs/Screenshot 2026-04-10 105737.png" class="thumb"><p>Another West-MEC project that tested our teamwork skills. Two other classmates and I made a multi-page website for a fictional PC store. My main job was design in CSS and HTML.</p>',
